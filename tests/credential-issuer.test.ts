...
describe('Credential Issuer Contract', () => {
  ...
  it('should issue credential', async () => {
    const result = await mockContractCall(contractName, 'issue-credential', ['ST2CY5V39NHDPWSXMW9QDT3HC3GD6Q6XX4CFRK9AG', 'https://example.com/credential/2', 'University B', 'Master of Arts', 1751328000]);
    expect(result.success).toBe(true);
